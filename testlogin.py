...
ORACLE_DSN = "127.0.0.1:1521/XE"   # ✅ Use XE PDB service name inside container
ORACLE_USER = "jay_user"                 # or the user you created
ORACLE_PASS = "oci"             # your Oracle XE password
